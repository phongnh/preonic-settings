 ...
 */
[_SYMBOL] = {
    {KC_NLCK, KC_P7,   KC_P8,   KC_P9,   KC_PSLS, KC_BSPC, KC_PGUP, KC_7,    KC_8,    KC_9,    KC_SLSH, KC_BSPC},
    {_______, KC_P4,   KC_P5,   KC_P6,   KC_PAST, KC_DEL,  KC_PGDN, KC_4,    KC_5,    KC_6,    KC_ASTR, KC_DEL},
    {KC_ESC,  KC_P1,   KC_P2,   KC_P3,   KC_PMNS, KC_PEQL, KC_HOME, KC_1,    KC_2,    KC_3,    KC_MINS, KC_EQL},
    {KC_FN1,  KC_P0,   KC_PDOT, KC_PCMM, KC_PPLS, KC_PENT, KC_END,  KC_0,    KC_DOT,  KC_COMM, KC_PLUS, _______},
...
[_ADJUST] = {
    ...
    {_______, RESET,   KC_WAKE, _______, _______, AG_NORM, AG_SWAP, BL_STEP, _______, _______, KC_PSCR, KC_INS},
    {KC_CAPS, _______, KC_SLEP, _______, KC_MPRV, KC_MPLY, KC_MNXT, QWERTY,  COLEMAK, DVORAK,  CUSTOM,  _______},
    {_______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, AU_TOG,  KC_F14,  KC_F15,  _______, _______},
    {_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______}
},
